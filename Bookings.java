...
public class Bookings {
    ...
    public void displayAvailableSeats() {
        ...
        try {
            ...
            // Display the remaining seats as a 6x14 matrix
            while (resultSet.next()) {
                ...
                count++;
                if ((count - 120) % 14 == 0) {
                    System.out.println(); // Move to the next line after every 14 seats beyond the first 120
                } else {
                    System.out.print("\t"); // Add a tab after each seat
                }
            }
